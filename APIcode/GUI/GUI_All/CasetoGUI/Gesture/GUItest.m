...
% Last Modified by GUIDE v2.5 04-Dec-2018 10:51:43
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
gesture=get(handles.popupmenu1,'Value')
...
val1
% if strcmp(list{val1},'Fist')==0
%     traindata_temp=load('testdata_fist.mat');
% elseif strcmp(list{val1},'Palm')==0
%     traindata_temp=load('testdata_palm.mat');
% elseif strcmp(list{val1},'Book')==0
%     traindata_temp=load('testdata_book.mat');
% end
global selectgesture;
selectgesture=val1;
% traindata=traindata_temp.movementData(:,1:500);
% figure;
% plot(1:500,traindata);
% xlabel('DataSize=500','fontsize',18);
% ylabel('mean(Signature)','fontsize',18);
Trainsample;
